                ...
                if (username.length() == 0 || email.length() == 0 || password.length() == 0 || confirm.length() == 0) {
                    ...
                    if (password.compareTo(confirm) == 0) {
                        ...
                        if (isValid(password)) {
                            ...
                            Toast.makeText(getApplicationContext(), "Password must contain at leat 8 character ,having latter,digit and special symbol", Toast.LENGTH_SHORT).show();
                        }

                    } else {
                        Toast.makeText(getApplicationContext(), "password and confirm Passwod didn't match", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
